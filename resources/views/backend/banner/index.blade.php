...
@section('title','MD-SHOP || Modifier un bannière')
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        ...
        <a href="{{route('banner.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
            data-placement="bottom" title="Ajouter un bannière"><i class="fas fa-plus"></i> Ajouter un bannière</a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{route('banner.destroy',[$banner->id])}}">
                                @csrf
                                @method('delete')
                                <button class="btn btn-danger btn-sm dltBtn" data-id={{$banner->id}} style="height:30px;
            ...
            @else
            <h6 class="text-center">Aucun bannière trouvé !!! Veuillez créer un bannière</h6>
            @endif
        </div>
    </div>
</div>
