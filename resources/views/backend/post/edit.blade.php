...
<div class="card">
    <h5 class="card-header">Modifier le post</h5>
    <div class="card-body">
        <form method="post" action="{{route('post.update',$post->id)}}">
            ...
            <div class="form-group">
                ...
                <input id="inputTitle" type="text" name="title" placeholder="Entrer le titre" value="{{$post->title}}"
                    class="form-control">
                @error('title')
            ...
            <div class="form-group">
                ...
                <select name="tags[]" multiple data-live-search="true" class="form-control selectpicker">
                    ...
                    <option value="{{$data->title}}" {{(( in_array( "$data->title" ,$post_tags ) ) ? 'selected' : ''
                        )}}>{{$data->title}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="added_by" class="form-control">
                    ...
                    <option value='{{$data->id}}' {{(($post->added_by==$data->id)? 'selected' : '')}}>{{$data->name}}
                    </option>
                    @endforeach
                </select>
            </div>
...
<script>
    ...
    $('#summary').summernote({
      placeholder: "Écrire un résumé court.....",
        tabsize: 2,
        height: 150
    });
    });
    ...
    $(document).ready(function() {
      $('#quote').summernote({
        placeholder: "Écrire une citation courte.....",
          tabsize: 2,
          height: 100
      });
    });
