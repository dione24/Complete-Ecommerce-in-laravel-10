...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left">Liste des posts</h6>
        <a href="{{route('post.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
            data-placement="bottom" title="Ajouter un post"><i class="fas fa-plus"></i> Ajouter un post</a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{route('post.destroy',[$post->id])}}">
                                @csrf
                                @method('delete')
                                <button class="btn btn-danger btn-sm dltBtn" data-id={{$post->id}} style="height:30px;
            ...
            @else
            <h6 class="text-center">Aucun post trouvé!!! Veuillez créer un post</h6>
            @endif
        </div>
    </div>
</div>
