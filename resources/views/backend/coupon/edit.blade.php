...
<div class="card">
    <h5 class="card-header">Modifier un coupon</h5>
    <div class="card-body">
        <form method="post" action="{{route('coupon.update',$coupon->id)}}">
            ...
            <div class="form-group">
                ...
                <input id="inputTitle" type="text" name="code" placeholder="Entrer le code du coupon"
            ...
            <div class="form-group">
                <label for="type" class="col-form-label"> <span class="text-danger">*</span></label>
            ...
            <div class="form-group">
                ...
                <input id="inputTitle" type="number" name="value" placeholder="Entrer la valeur du coupon"
