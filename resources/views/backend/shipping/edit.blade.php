...
<div class="card">
    <h5 class="card-header">Modifier la livraison</h5>
    <div class="card-body">
        <form method="post" action="{{route('shipping.update',$shipping->id)}}">
            ...
            <div class="form-group">
                ...
                <input id="inputTitle" type="text" name="type" placeholder="Entrer le type" value="{{$shipping->type}}"
                    class="form-control">
                @error('type')
            ...
            <div class="form-group">
                ...
                <input id="price" type="number" name="price" placeholder="Entrer le prix" value="{{$shipping->price}}"
                    class="form-control">
                @error('price')
                <span class="text-danger">{{$message}}</span>
                @enderror
