...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left">Liste des étiquettes de post</h6>
        <a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
            data-placement="bottom" title="Ajouter une étiquette de post"><i class="fas fa-plus"></i> Ajouter une
            étiquette de post</a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{route('post-tag.destroy',[$data->id])}}">
                                @csrf
                                @method('delete')
                                <button class="btn btn-danger btn-sm dltBtn" data-id={{$data->id}} style="height:30px;
            ...
            @else
            <h6 class="text-center">Aucune étiquette de post trouvée!!! Veuillez créer une étiquette de post</h6>
            @endif
        </div>
    </div>
</div>
