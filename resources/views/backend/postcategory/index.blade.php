...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left">Liste des catégories de post</h6>
        <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
            data-placement="bottom" title="Ajouter une catégorie de post"><i class="fas fa-plus"></i> Ajouter une
            catégorie de post</a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            ...
            @else
            <h6 class="text-center">Aucune catégorie de post trouvée!!! Veuillez créer une catégorie de post</h6>
            @endif
        </div>
    </div>
</div>
