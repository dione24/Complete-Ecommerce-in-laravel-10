...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        ...
        <a href="{{route('users.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
            data-placement="bottom" title="Ajouter un utilisateur"><i class="fas fa-plus"></i> Ajouter un
            utilisateur</a>
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{route('users.destroy',[$user->id])}}">
                                @csrf
                                @method('delete')
                                <button class="btn btn-danger btn-sm dltBtn" data-id={{$user->id}} style="height:30px;
