                                    ...
                                    <div class="button-head">
                                        <div class="product-action">
                                            <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View"
                                                href="#"><i class=" ti-eye"></i><span>Voir le produit</span></a>
                                        ...
                                        <div class="product-action-2">
                                            <a title="Add to cart"
                                                href="{{route('add-to-cart',$product->slug)}}">Ajouter au panier</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="single-banner">
                    ...
                    <div class="content">
                        ...
                        <a href="{{route('product-detail',$data->slug)}}">Voir le produit</a>
                    </div>
                </div>
            </div>
            <!-- /End Single Banner  -->
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <h3><small><del class="text-muted">${{number_format($product->price,2)}}</del></small>
                                {{number_format($after_discount,2)}} FCFA </h3>
