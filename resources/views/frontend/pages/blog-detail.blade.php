            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="javascript:void(0);">Article</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="blog-detail">
                                ...
                                <div class="blog-meta">
                                    <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>Par
                                            {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i
                                                class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a
                                            href="javascript:void(0);"><i class="fa fa-comments"></i>Commentaires
                                            ...
                                            <div class="col-12">
                                                <div class="form-group button">
                                                    <button type="submit" class="btn"><span
                                                            class="comment_btn comment">Poster un
                                                            commentaire</span><span class="comment_btn reply"
                                                            style="display: none;">Répondre à un
                        ...
                        <p class="text-center p-5">
                            You need to <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> OR <a
                                style="color:blue" href="{{route('register.form')}}">Register</a> for comment.
                        ...
                        <div class="col-12">
                            <div class="comments">
                                ...
                                <!-- Single Comment -->
                                @include('frontend.pages.comment', ['comments' => $post->comments, 'post_id' =>
                                $post->id, 'depth' => 3])
                                <!-- End Single Comment -->
                            </div>
                        </div>
                ...
                <div class="main-sidebar">
                    ...
                    <div class="single-widget recent-post">
                        ...
                        <div class="single-post">
                            ...
                            <div class="content">
                                ...
                                <ul class="comment">
                                    <li><i class="fa fa-calendar" aria-hidden="true"></i>{{$post->created_at->format('d
                                        M, y')}}</li>
                    ...
                    <div class="single-widget newsletter">
                        ...
                        <div class="letter-inner">
                            <h4>S'abonner et recevoir les dernières mises à jour.</h4>
