            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="javascript:void(0)">Passer à la caisse</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-12">
                    <div class="checkout-form">
                        ...
                        <p>Veuillez vous enregistrer pour passer à la caisse plus rapidement</p>
                        <!-- Form -->
                        <div class="row">
                ...
                <div class="col-lg-4 col-12">
                    <div class="order-details">
                        ...
                        <div class="single-widget">
                            ...
                            <div class="content">
                                <ul>
                                    <li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Total du
                                        panier<span>${{number_format(Helper::totalCartPrice(),2)}}</span></li>
                                    <li class="shipping">
                                        Frais de livraison
                                    ...
                                    <li class="coupon_price" data-price="{{session('coupon')['value']}}">Vous
                                        économisez<span>${{number_format(session('coupon')['value'],2)}}</span></li>
                                    @endif
                                    @php
                        ...
                        <div class="single-widget">
                            ...
                            <div class="content">
                                <div class="checkbox">
                                    ...
                                    <form-group>
                                        <input name="payment_method" type="radio" value="cod"> <label> Paiement à la
                                            livraison</label><br>
        ...
        <div class="inner-top">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-12">
                    ...
                    <div class="inner">
                        <h4>Newsletter</h4>
                        <p> Inscrivez-vous à notre newsletter et obtenez <span>10%</span> de réduction sur votre
                            première commande</p>
