                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}"
                                    class='btn text-white'>Ajouter au panier</a></td>
                        ...
                        <tr>
                            <td class="text-center">
                                Il n'y a aucun produit dans votre liste de souhaits. <a
                                    href="{{route('product-grids')}}" style="color:blue;">Continuer vos achats</a>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <h3>{{$wishlist->product['price']}}</h3>
                            <div class="quickview-peragraph">
                                <p>{!!$wishlist->product['summary']!!}</p>
                            </div>
                            <div class="size">
                                <div class="row">
