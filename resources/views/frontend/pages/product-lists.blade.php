...
@section('title','MD-SHOP || PRODUCT PAGE')
                                ...
                                <div class="price-filter-inner">
                                    ...
                                    <div class="price_slider_amount">
                                        <div class="label-input">
                                            <span>Range:</span>
                                            <input type="text" id="amount" name="price_range" value='@if(!empty($_GET['
                                                price'])) {{$_GET['price']}} @endif' placeholder="Add Your Price" />
                                        </div>
                                    </div> --}}
                                    @php
                                    ...
                                    <div class="single-shorter">
                                        ...
                                        <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                            ...
                                            <option value="title" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='title' ) selected @endif>Nom</option>
                                            <option value="price" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='price' ) selected @endif>Prix</option>
                                            <option value="category" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='category' ) selected @endif>Catégorie</option>
                                            <option value="brand" @if(!empty($_GET['sortBy']) &&
                                                $_GET['sortBy']=='brand' ) selected @endif>Marque</option>
                                        </select>
                                    </div>
                                </div>
                                <ul class="view-mode">
                            ...
                            <div class="row">
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    <a data-toggle="modal" data-target="#{{$product->id}}"
                                                        title="Quick View" href="#"><i class=" ti-eye"></i><span>Aperçu
                                                            rapide</span></a>
                                                    <a title="Wishlist"
                                                        href="{{route('add-to-wishlist',$product->slug)}}"
                                                        class="wishlist" data-id="{{$product->id}}"><i
                                                            class=" ti-heart "></i><span>Ajouter à votre liste de
                                                            souhaits</span></a>
                                                </div>
                                ...
                                <div class="col-lg-8 col-md-6 col-12">
                                    <div class="list-content">
                                        ...
                                        <a href="javascript:void(0)" class="btn cart" data-id="{{$product->id}}">Acheter
                                            maintenant !</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="quickview-content">
                            ...
                            <div class="quickview-ratting-review">
                                <div class="quickview-ratting-wrap">
                                    ...
                                    <a href="#"> ({{$rate_count}} avis)</a>
                                </div>
                                <div class="quickview-stock">
                                    @if($product->stock >0)
                                    <span><i class="fa fa-check-circle-o"></i> {{$product->stock}} en stock</span>
                                    @else
                                    <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} en
                                        rupture de
                                        stock</span>
                                    @endif
                                </div>
