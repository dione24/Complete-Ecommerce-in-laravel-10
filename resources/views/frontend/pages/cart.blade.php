                        ...
                        <form action="{{route('cart.update')}}" method="POST">
                            ...
                            <tr>
                                <td class="text-center">
                                    Il n'y a aucun panier disponible. <a href="{{route('product-grids')}}"
                                        style="color:blue;">Continuer à shop</a>
                            ...
                            <div class="left">
                                <div class="coupon">
                                    <form action="{{route('coupon-store')}}" method="POST">
                                        @csrf
                                        <input name="code" placeholder="Entrez votre coupon">
                        ...
                        <div class="col-lg-4 col-md-7 col-12">
                            <div class="right">
                                ...
                                <div class="button5">
                                    ...
                                    <a href="{{route('product-grids')}}" class="btn">Continuer à shop</a>
                                </div>
                            </div>
                        </div>
                    </div>
