...
@section('title','MD-SHOP || Suivi de commande')
...
<section class="tracking_box_area section_gap py-5">
    <div class="container">
        <div class="tracking_box_inner">
            <p>Pour suivre votre commande, veuillez entrer votre numéro de commande dans la case ci-dessous et appuyer
                sur le bouton "Suivre". Ce numéro a été fourni à vous sur votre reçu et dans l'e-mail de confirmation
