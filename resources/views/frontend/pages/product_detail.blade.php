...
@endsection
@section('title','MD-SHOP || Détail du produit')
            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="">Détail du produit</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="product-des">
                            ...
                            <div class="product-buy">
                                ...
                                <p class="cat mt-1">Sous-catégorie :<a
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="comment-review">
                                                    <div class="add-review">
                                                        ...
                                                        <p>Votre adresse e-mail ne sera pas publiée. Les champs requis
                                                            sont marqués</p>
                                                    </div>
                                                ...
                                                <div class="ratting-main">
                                                    <div class="avg-ratting">
                                                        ...
                                                        <span>Basé sur {{$product_detail->getReview->count()}}
                                                            Avis</span>
                                                    </div>
                        ...
                        <div class="product-img">
                            ...
                            <div class="button-head">
                                <div class="product-action">
                                    ...
                                    <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Ajouter à votre liste
                                            de souhaits</span></a>
                                    <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Ajouter à la
                                            comparaison</span></a>
                                </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <h3>${{number_format($data->price,2)}}</h3>
