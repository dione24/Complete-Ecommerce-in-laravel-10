                    ...
                    <div class="form-main">
                        <div class="title">
                            ...
                            <h3>Écrivez-nous un message @auth @else<span style="font-size:12px;"
                                    class="text-danger">[Vous devez vous connecter d'abord]</span>@endauth</h3>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="subject" type="text" id="subject" placeholder="Entrez votre sujet">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>Votre e-mail<span>*</span></label>
                                        <input name="email" type="email" id="email" placeholder="Entrez votre e-mail">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
