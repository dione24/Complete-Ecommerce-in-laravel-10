                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            @else
                            <li><i class="ti-power-off"></i><a href="{{route('login.form')}}">Connexion /</a> <a
                                    href="{{route('register.form')}}">Inscription</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            ...
                            <form method="POST" action="{{route('product.search')}}">
                                @csrf
                                <input name="search" placeholder="Rechercher des produits..." type="search">
                                    ...
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='about-us' ? 'active' : ''}}"><a
                                                    href="{{route('about-us')}}">À propos</a></li>
                                            <li
                                                class="@if(Request::path()=='product-grids'||Request::path()=='product-lists') active @endif">
                                                <a href="{{route('product-grids')}}">Produits</a><span
                                                    class="new">Nouveau</span>
                                            </li>
